...
so I could prompt it with facts instead of guesses: the actual rendered page, the real CSS,
...
(invalid enums rejected, the honeypot writing nothing), and end to end against the real
